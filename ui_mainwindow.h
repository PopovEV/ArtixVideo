...
public:
    ...
    QProgressBar *progressBar_loadVideo;
...
" }"));
        ...
        progressBar_loadVideo = new QProgressBar(dockWidgetContents);
        progressBar_loadVideo->setObjectName(QString::fromUtf8("progressBar_loadVideo"));
        progressBar_loadVideo->setMaximumSize(QSize(16777215, 5));
        progressBar_loadVideo->setValue(0);
        progressBar_loadVideo->setAlignment(Qt::AlignCenter);
        progressBar_loadVideo->setTextVisible(false);

        verticalLayout->addWidget(progressBar_loadVideo);
...
"}"));
        ...
        QWidget::setTabOrder(tabWidget, pushButton_Find);
        QWidget::setTabOrder(pushButton_Find, tableView);
        QWidget::setTabOrder(tableView, pushButton_PreviousFragment);
        QWidget::setTabOrder(pushButton_PreviousFragment, pushButton_Play);
        QWidget::setTabOrder(pushButton_Play, pushButton_Pause);
        QWidget::setTabOrder(pushButton_Pause, pushButton_Stop);
        QWidget::setTabOrder(pushButton_Stop, pushButton_NextFragment);
        QWidget::setTabOrder(pushButton_NextFragment, pushButton_FullScreen);
        QWidget::setTabOrder(pushButton_FullScreen, listView_Subtitles);
